...
<?= $this->section('judul') ?>
<h3><i class="fa fa-fw fa-table"></i> Manajemen Data Barang</h3>
<?= $this->endSection() ?>
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tabel List Barang</h6>
        </div>
        <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($barang as $row) :
                            $jumlah += $row['harga_jual'] * $row['stok'];
                        ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                ...
                                <td>Rp.<?= number_format(($row['harga_jual'] * $row['stok']), 0, ',', '.'); ?></td>
